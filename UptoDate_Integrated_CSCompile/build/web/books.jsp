<%-- 
    Document   : books
    Created on : Feb 16, 2017, 2:05:42 AM
    Author     : rmaclea1
--%>
...
<html>
    ...
    <body>
      ...
      <div class="blk-border">
        ...
        <h1 class="text-center text-primary underline" style = "padding-top:25px">Books</h1>
        ...
        <a href="submitbook.html"><button style = "background-color: blue" class = "btn btn-primary well">Submit Post</button></a>
        <%
         String sql = "select Title, Member_ID, Date, Post_ID FROM posts WHERE Type='1' ORDER BY Post_ID DESC";
