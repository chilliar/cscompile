<%-- 
    Document   : coding
    Created on : Feb 16, 2017, 2:06:10 AM
    Author     : rmaclea1
--%>
    ...
    <body>
      ...
      <div class="blk-border">
        ...
        <ul>
            ...
            <li><a class = "active" href="coding.jsp">Code</a></li>
        ...
        <h1 class="text-center text-primary underline" style = "padding-top:25px">Code Posts</h1>
        ...
        <div class ="col-md-8" id="Recent Code Posts">
            <a href ="submitcode.html"><button style = "background-color: blue" class = "btn btn-primary well">Submit Post</button></a>
        <%
         String sql = "select Title, Member_ID, Date, Post_ID FROM posts WHERE Type='2' ORDER BY Post_ID DESC";
